...
public class QueuesAndStacks {
    ...
    public static <E> void reverse(Stack<E> stack) {
        ...
        // Stack in die Queue entleeren
        while (!stack.isEmpty()) {
            tempQueue.add(stack.pop());
        }
        // Queue zurück in den Stack schieben (Reihenfolge ist nun umgekehrt)
    ...
    public static <E> void reverse(Queue<E> queue) {
        ...
        // Queue in den Stack entleeren
        while (!queue.isEmpty()) {
            tempStack.push(queue.poll());
        }
        // Stack zurück in die Queue schieben
